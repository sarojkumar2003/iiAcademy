 ...
 * - Clicking "Enroll" persists a simple enrollment object in localStorage
 *   then navigates to a course-specific dashboard route: /course/backend
 *
 * Make sure you have the following routes in your router (App.jsx):
 *   <Route path="/backend" element={<Backend />} />
 *   <Route path="/course/:courseId" element={<CourseDetails />} />
 *
 * If you don't want /course/:courseId, change navigate(...) below to navigate("/backend-dashboard") and
 * create a route for that path instead.
 */
...
export default function Backend() {
  ...
  const scrollTrack = (dir = 1) => {
    ...
    const step = card ? card.clientWidth + 24 /* gap */ : 340;
  ...
  const handleEnroll = (e) => {
    ...
    const amount = dataset.courseAmount ? Number(dataset.courseAmount) : 50000;
      ...
      <nav id="navbar" className="fixed top-0 left-0 right-0 bg-white shadow-md z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <a href="#hero">
              <img src={logo} alt="logo" className="h-20 mt-2" />
            </a>
        ...
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-600 to-purple-600">
          ...
          <div className="relative container mx-auto px-4 py-24 flex flex-col items-center text-center z-10">
            ...
            <div className="transform hover:scale-105 transition duration-500">
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in">Backend Development Program</h1>
              <p className="text-xl md:text-2xl text-white mb-8 animate-slide-up">Build robust server-side applications with Node.js, Express and MongoDB.</p>
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/95 text-lg">Join hundreds of developers who have built scalable backends.</p>
              </div>
            </div>
        ...
        <section id="overview" className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Your journey to become a backend developer starts here.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {["Foundations", "Advanced Skills", "Industry Projects"].map((title, i) => (
                <div key={title} className="bg-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition">
                  ...
                  <p className="text-gray-600 text-center">{i === 0 ? "Master server fundamentals and RESTful APIs" : i === 1 ? "Authentication, testing, performance and scaling" : "Build production-ready projects and deploy them"}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Practice building and debugging servers with instructors.</p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">One-on-one help with projects, interviews and deployment.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[{
                ...
                items: ["Node.js intro, npm, modules", "Express.js, routing and middleware"]
              },{
                name: "Advanced Concepts",
                items: ["Authentication & Authorization (JWT, OAuth)", "Databases, indexing, and aggregation (MongoDB)"]
              },{
                name: "Real-World Projects",
                items: ["REST APIs, background workers, queues", "Deployment, CI/CD and monitoring"]
              },{
                name: "Career Preparation",
                items: ["System design basics", "Interview practice and portfolio building"]
              }].map((m) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-center gap-2">📫 info@iiacademy.in</li>
              </ul>
            </div>
          </div>
...
/* Small check icon component used in lists */
